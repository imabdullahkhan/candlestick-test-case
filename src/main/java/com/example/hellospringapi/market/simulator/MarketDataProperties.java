...
public class MarketDataProperties {
    ...
    public long getSimulatorFixedRateMs() { return simulatorFixedRateMs; }
    public void setSimulatorFixedRateMs(long simulatorFixedRateMs) { this.simulatorFixedRateMs = simulatorFixedRateMs; }
    public int getSimulatorMinTicksPerRun() { return simulatorMinTicksPerRun; }
    public void setSimulatorMinTicksPerRun(int simulatorMinTicksPerRun) { this.simulatorMinTicksPerRun = simulatorMinTicksPerRun; }
    public int getSimulatorMaxTicksPerRun() { return simulatorMaxTicksPerRun; }
    public void setSimulatorMaxTicksPerRun(int simulatorMaxTicksPerRun) { this.simulatorMaxTicksPerRun = simulatorMaxTicksPerRun; }
}
