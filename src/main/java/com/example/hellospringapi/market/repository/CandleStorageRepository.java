package com.example.hellospringapi.market.repository;
...
public class CandleStorageRepository {
    ...
    public void upsert(String symbol, CandleInterval interval, Candle candle) {
        ...
        try {
            ...
            log.error("DB upsert failed: symbol={} interval={} time={}: {}", symbol, interval.value(), candle.time(), e.getMessage());
            throw e;
        }
    }
    ...
    public List<Candle> findHistory(String symbol, CandleInterval interval, long from, long to) {
        ...
        try {
            ...
            log.error("DB query failed: symbol={} interval={} from={} to={}: {}", symbol, interval.value(), from, to, e.getMessage());
